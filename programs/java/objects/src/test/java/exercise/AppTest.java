...
class AppTest {
    ...
    // BEGIN
    @Test
    void testGetYoungestUser() throws Exception {
        String[][] users = {
            {"Andrey Petrov", "1990-11-23"},
            {"Aleksey Ivanov", "1995-02-15"},
            {"Anna Sidorova", "1996-09-09"},
        ...
        String actual1 = App.getYoungestUser(users, "10 Aug 1800");
        assertThat(actual1).isEqualTo("");

        String actual2 = App.getYoungestUser(users, "11 Jul 1989");
        String expected2 = "John Smith";
        assertThat(actual2).isEqualTo(expected2);

        String actual3 = App.getYoungestUser(users, "15 Sep 1995");
        String expected3 = "Aleksey Ivanov";
