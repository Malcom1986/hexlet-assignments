...
class PointTest {
    ...
    void testGetSymmetricalPointByX() {
        ...
        var symmetricalPoint = Point.getSymmetricalPointByX(point);
        assertThat(getX(symmetricalPoint)).isEqualTo(-2);
        assertThat(getY(symmetricalPoint)).isEqualTo(-3);
    }

    @Test
    void testCalculateDistance() {
        var point1 = makePoint(1, 10);
        var point2 = makePoint(1, 3);
