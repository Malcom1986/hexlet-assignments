class PostCommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post_comment.save
        format.html { redirect_to post_comment_path(@post_comment), notice: "Post comment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @post_comment.update(post_comment_params)
        format.html { redirect_to post_comment_path(@post_comment), notice: "Post comment was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_post_comments_url, notice: "Post comment was successfully destroyed." }
