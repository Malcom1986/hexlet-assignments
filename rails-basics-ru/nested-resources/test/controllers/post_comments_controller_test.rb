...
class PostCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get new" do
    get new_post_post_comment_path(@post_comment.post)
    assert_response :success
  end

  test "should create post_comment" do
    assert_difference("PostComment.count") do
      post post_post_comments_path(@post_comment.post), params: { post_comment: { body: @post_comment.body, post_id: @post_comment.post_id } }
    end
